...
class MessageItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Align(
      alignment:
          // message.author == name ? Alignment.topRight : Alignment.topLeft,
          message.sender == "user" ? Alignment.topRight : Alignment.topLeft,
      child: Chip(
        // backgroundColor: message.author == name
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Widget build(BuildContext context) {
    // print(name);
    // Provider.of<MyDataModel>(context, listen: false).fetchLocation();
    // Consumer<MyDataModel>(builder: (context, myModel, child) {
    //   print(myModel.jsonResponse);
    //   print("print the fucking thing");
    // });
    // print("print the fucking thing");
