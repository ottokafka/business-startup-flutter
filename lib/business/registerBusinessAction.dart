...
registerBusiness(
    firstName, lastName, email, password, phoneNumber, firebaseToken) async {
  // in web use localhost but in android use 10.0.2.2
  // ios work with 127.0.0.1
  print(firebaseToken);
  try {
    var url = ConfigURL.postApiRegisterBusiness;
...
//  print(parsedJson["token"]);
    ...
    // prefs.setStringList('barberinfo', [firstName, lastName, email, phoneNumber]);
