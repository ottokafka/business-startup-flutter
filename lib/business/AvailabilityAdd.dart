...
import 'package:business_startup/business/availabilityAction.dart';
                    ...
                    GestureDetector(
                      ...
                      child: _Menu(
                        children: [
                          ...
                          Text(
                            DateFormat.j().format(start_time1),
                            style:
                                TextStyle(color: CupertinoColors.inactiveGray),
                          ),
                        ],
                    ...
                    GestureDetector(
                      ...
                      child: _Menu(
                        children: [
                          ...
                          Text(
                            DateFormat.j().format(start_time2),
                            style:
                                TextStyle(color: CupertinoColors.inactiveGray),
                          ),
                        ],
                    ...
                    GestureDetector(
                      ...
                      child: _Menu(
                        children: [
                          ...
                          Text(
                            DateFormat.j().format(start_time3),
                            style:
                                TextStyle(color: CupertinoColors.inactiveGray),
                          ),
                        ],
                    ...
                    GestureDetector(
                      ...
                      child: _Menu(
                        children: [
                          ...
                          Text(
                            DateFormat.j().format(start_time4),
                            style:
                                TextStyle(color: CupertinoColors.inactiveGray),
                          ),
                        ],
                    ...
                    GestureDetector(
                      ...
                      child: _Menu(
                        children: [
                          ...
                          Text(
                            DateFormat.j().format(start_time5),
                            style:
                                TextStyle(color: CupertinoColors.inactiveGray),
                          ),
                        ],
                    ...
                    GestureDetector(
                      ...
                      child: _Menu(
                        children: [
                          ...
                          Text(
                            DateFormat.j().format(start_time6),
                            style:
                                TextStyle(color: CupertinoColors.inactiveGray),
                          ),
                        ],
                    ...
                    GestureDetector(
                      ...
                      child: _Menu(
                        children: [
                          ...
                          Text(
                            DateFormat.j().format(start_time7),
                            style:
                                TextStyle(color: CupertinoColors.inactiveGray),
                          ),
                        ],
            ...
            onPressed: () {
              secondFunction() async {
                await addAvailability(
                  ...
                  work6,
                  work7,
                  DateFormat.H().format(start_time1),
                  DateFormat.H().format(end_time1),
                  DateFormat.H().format(start_time2),
                  DateFormat.H().format(end_time2),
                  DateFormat.H().format(start_time3),
                  DateFormat.H().format(end_time3),
                  DateFormat.H().format(start_time4),
                  DateFormat.H().format(end_time4),
                  DateFormat.H().format(start_time5),
                  DateFormat.H().format(end_time5),
                  DateFormat.H().format(start_time6),
                  DateFormat.H().format(end_time6),
                  DateFormat.H().format(start_time7),
                  DateFormat.H().format(end_time7),
